...
date: 2023-11-06
year: 2023
summary: '模型的知识是训练时"背进去"的，一旦训练完就冻住了——你问它昨天的新闻、公司内部文档，它要么不知道，要么瞎编。RAG 的意义，是在模型回答之前先去检索相关资料，把找到的内容塞进上下文，让模型"有据可查"地回答，而不是靠记忆硬撑。它是让模型接入私有知识、实时信息的最直接方式，也是企业落地 AI 问答场景的标配方案。'
phase: mainstream
trend: stable
