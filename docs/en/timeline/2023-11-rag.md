...
date: 2023-11-06
year: 2023
summary: An architecture that combines external retrieval with generation so models can ground outputs in non-parametric knowledge, becoming a key foundation for knowledge-enhanced AI applications.
phase: mainstream
trend: stable
